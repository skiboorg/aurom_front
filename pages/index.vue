...
<!--  </section>-->
  <section class="bg-gray-50 py-20">
    <div class="container">
      <h3 class="font-medium text-2xl md:text-4xl mb-5">{{t('about_add_service_title')}}</h3>
      <p class="opacity-60 text-md md:text-xl whitespace-pre-line mb-9">{{t('about_add_service_text')}}</p>
